...
def register(request):
    ...
    if request.method == "POST":
        ...
        # otherwise
            ...
            registered = User.objects.create(first_name=request.POST["first_name"], last_name=request.POST["last_name"], email=request.POST["email"], password=pw_hash.decode(), current_lesson=0, current_sub_lesson=0, belt_rank=1, dojo_points=0)
